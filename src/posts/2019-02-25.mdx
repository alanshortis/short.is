...
intro: "The React documentation is really detailed and extensive, but sometimes the examples aren't quite simplified enough. Let's use Render Props in a really simple, real world example."
---
