...
slug: '/writing/webpack-and-babel-for-react-from-scratch'
...
<a class="anchor" name="assumptions" />
...
<a class="anchor" name="create-app" />
...
<a class="anchor" name="dev-server" />
...
<a class="anchor" name="styled-components" />
...
<a class="anchor" name="code-quality" />
...
<a class="anchor" name="production-build" />
...
<a class="anchor" name="conclusion" />
