...
- `prefix` is what you type in VS Code to use the snippet. You can either type this directly into the file and hit tab, or hit <kbd>cmd</kdb>+<kbd>shift</kdb>+<kbd>p</kdb> to open the command palette and type 'insert snippet' to see a list.
