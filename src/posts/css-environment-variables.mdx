...
<picture>
  <source srcSet="/img/pitchfork@2x.avif 2x" type="image/avif" />
  <source srcSet="/img/pitchfork.avif" type="image/avif" />
...
<picture>
  <source srcSet="/img/bottom-menu@2x.avif 2x" type="image/avif" />
  <source srcSet="/img/bottom-menu.avif" type="image/avif" />
