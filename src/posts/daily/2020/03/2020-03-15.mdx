...
Last time I set myself some rules, and I think they still apply. They're things that anyone should be doing anyway but it's very easy to lose the thread and let it go.
