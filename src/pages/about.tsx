    ...
    <Layout title="About">
      <Grid>
        ...
        <PageBody as={PostFormatting}>
          <h2 className="intro">
            I&#39;m Alan Shortis, a front end developer based in <del>London</del> Nottingham. I work for{' '}
            <a href="https://monzo.com/">Monzo</a>, write, and take photographs.
          </h2>
          <p>
            I like building scalable, accessible, and performant design systems and websites using HTML, CSS,
            and JavaScript. The combination of code, design, and empathy for end users is what makes me want
            to do my best work.
          </p>
          ...
          <p>
            ...
            nice DX, and any visitors the bare minimum of bytes.
          </p>
          <p>
