...
<aside class="longform">
<span class="label">Updated <time datetime="2026-06-12">13 June 2026</time></span>

Since writing this I have had a lot of time to think about AI. It's utterly inescpabable, especially when working in tech. I have come to two related and opposing conclusions: I will lean into AI as responsibly as possible for my job, and I will not use AI at all outside of my job. At all. That includes this site, and any other side projects.

This is a compromise. Resisting AI in my job is only going to lead to redundancy; I have to integrate it into what I do each day in order to keep pace and continue to make a living. Beyond that, I will work through problems without AI assistance, retaining friction and authenticity; where it doesnt affect anyone but me, where it's supposed to be fun, and where I can learn from getting stuck.

I'd like to find a way to have nothoing to do with AI at all; the harm vastly outweighs any perceived benefits and the same tool that spits out average code in my 9 to 5 has been used to [plan literal wars](https://www.wsj.com/livecoverage/iran-strikes-2026/card/u-s-strikes-in-middle-east-use-anthropic-hours-after-trump-ban-ozNO0iClZpfpL7K7ElJ2).

I hope to never mention AI here again. My [reading list](/reading) has rapidly turned into a long string of anti-AI sentiment, so the best thing I can do is to stop giving it any oxygen.

And no, LLMs are not calculators for language. Calculators are deterministic, logical, do not make shit up just to try and please you, and are not built on industrial scale plagarism and bias.
