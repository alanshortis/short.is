...
An LLM can analyse a huge number of documents and summarise, find patterns, make connections, and come to conclusions that it would take a human years to arrive at.

[Cursor](https://www.cursor.com/en) and [Copilot](https://github.com/features/copilot) are not very good at writing code from zero with a vague prompt. However, let it learn your codebase and it'll get very good at finishing your thoughts very quickly. Even then, it's not going to get it right every time but it can take the concept of autocomplete to a new level.

These tools work best when you collaborate with them. It seems dumb at first, but if you treat a series of prompts and responses like a conversation with a human you get better results. Tell it when you already know, what you want to achieve, and it'll help you get there.
...
I do not use AI for personal work. This website and all the content within was written by hand, because I enjoy the process just as much as the outcome. That's not to say I never use AI outside of my job; the days of googling a particularly tricky code problem leading to 65 open tabs and still no answers are over. Describing the issue to Perplexity gets me an explanation, code samples, and sources. I read, learn, understand, and then implement.
