...
<figure>
  <blockquote>
    Read this text carefully and look for spelling errors, repetition, variation in tense, poor word choice,
    and any other issues that may reduce the quality and readability. Do not make any edits directly;
    summarise your findings and I will work through them and make the changes myself.
  </blockquote>
</figure>
...
Lightroom has AI image generation built in and can do a good job of fixing these flaws in a pretty convincing way. Yeah, I can save a photo that I wish I'd nailed, but is it still the same if that save was made by AI? That is not a door I want to open. I need to keep that boundary between utility and artistry.
